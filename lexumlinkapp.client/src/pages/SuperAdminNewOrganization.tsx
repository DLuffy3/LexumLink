...
export default function SuperAdminNewOrganization() {
    const { user } = useAuth();
    ...
    return (
        <>
            <HelpButton
                ...
                description="Create a new, empty organisation ahead of assigning people to it."
                steps={[
                    'Useful for a Custom-tier customer that needs several organisations set up before you assign their staff into each one.',
                    'Choosing a plan pre-fills suggested user/client/storage limits — you can still adjust any of them.',
                    'Once created, assign people to it from the Users page (edit a user, pick this organisation).',
                ]}
            />
