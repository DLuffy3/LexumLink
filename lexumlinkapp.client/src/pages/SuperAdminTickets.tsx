...
export default function SuperAdminTickets() {
    ...
    return (
        <>
            <HelpButton
                title="Tickets"
                description="Bug reports and feature requests submitted by users across all organisations."
                steps={[
                    'Use the status dropdown on each ticket to move it through New → Active → Complete (or Critical if urgent).',
                    'Each ticket shows who submitted it and from which organisation.',
                ]}
            />
